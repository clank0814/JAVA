...
public class _2_Jugador {
    ...
    public _2_Jugador(int ID, String nombre, boolean mojado) {
        this.ID = ID;
        this.nombre = nombre;
        this.mojado = mojado;
    }
...
// METODO    
    public boolean disparo(_2_RevolverDeAgua r) {
        
            // LLAMADO A LOS METODOS  (CLASE _2_RevolverDeAgua)
            boolean band = false;
            if (r.mojar() == true) {     // SI EL METODO mojar() RETORNA TRUE SE CUMPLE
                band = true;
                mojado = true;
            }
                r.siguienteChorro();
